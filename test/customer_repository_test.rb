...
class CustomerRepositoryTest < Minitest::Test
  ...
  def test_it_can_load_data_to_customer
    ...
    refute_equal 2, customer_repository.customers.last.id
  ...
  def test_it_can_return_all_customers
    ...
    bad_result = customer_repository.all.map { |customer| customer.first_name }

    assert_equal [1, 2, 3, 4, 5], result
    refute_equal [1, 2, 3, 4, 5], bad_result
  end
  ...
  def test_it_knows_a_customers_first_name
    customer_repository = CustomerRepository.new(nil)
    customer_repository.load_data("./test/fixtures/customers.csv")
    ...
    refute_equal 1, customer_repository.find_by_first_name("Mariah").id
  end

  def test_it_knows_a_customers_last_name
    customer_repository = CustomerRepository.new(nil)
    customer_repository.load_data("./test/fixtures/customers.csv")

    assert_equal "Mariah", customer_repository.find_by_last_name("Toy").first_name
    refute_equal "Joey", customer_repository.find_by_last_name("Toy").first_name
